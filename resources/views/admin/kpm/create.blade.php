...
@section('header')
    <h1 class="m-0">Buat Data KPM Baru</h1>
@endsection
@push('css')
    <link rel="stylesheet"
...
@section('content')
    <div class="container clearfix">
        <div class="form-widget">
            ...
            <div class="row">
                <div class="col-lg-10">
                    <form class="row" action="{{route('kpmadm.store')}}" method="post"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="input-group nk-int-st">
                                    <select class="form-control select2" id="id_kec" name="id_kec"
                                            style="width: 100%;"
                                            required>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <select class="form-control select2" id="desa_id" name="desa_id"
                                            style="width: 100%;"
                                            required>
                                        <option selected="selected" value="">-- Pilih Desa/Kelurahan --</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 form-group">
                            ...
                            <input type="text" name="nama_kpm" id="freelance-quote-name"
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $('#id_kec').change(function () {
                var id = $(this).val();
                $.ajax({
                    url: "{{url('tppskec/loaddesa')}}/" + id,
                    method: "GET",
                    data: {id: id},
                    async: true,
                    dataType: 'json',
                    success: function (data) {
                        var html = '<option selected>-- Pilih Desa -- </option>';
                        var i;
